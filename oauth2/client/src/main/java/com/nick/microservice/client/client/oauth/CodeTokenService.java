...
public class CodeTokenService {
    ...
    public String getAuthorizationEndpoint() {
        ...
        authParameters.put("redirect_uri",
                getEncodedUrl("http://localhost:9090/client/token/code"));
        authParameters.put("scope", getEncodedUrl("user"));
    ...
    /**
     * 使用 授权码请求授权服务器获取 Token
     * @param authorizationCode
     * @return
     */
    public OAuth2Token getToken(String authorizationCode) {
        RestTemplate rest = new RestTemplate();
        String authBase64 = configuration.encodeCredentials("client",
                "secret");
